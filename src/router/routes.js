...
const routes = [
  {
    ...
    children: [
      ...
      { name: 'Perfil', path: '/aluno/:id', meta: { auth: true }, component: () => import('pages/Aluno.vue') },
      ...
      { name: 'Desafio', path: '/desafio/:id/:idTurma', meta: { auth: true }, component: () => import('pages/Desafio.vue') }
    ]
  },
  {
    name: 'sair',
